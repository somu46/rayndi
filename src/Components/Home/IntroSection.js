...
function IntroSection() {
  return (
    <div className=" p-8 lg:mt-52 mx-auto max-w-5xl rounded-lg shadow-lg">
      <div className="intro-text lg:mt-[10.5rem]">
        <h1 className="text-3xl md:text-4xl lg:text-5xl  mt-[4rem] font-bold text-center text-indigo-600 mb-6">
          Rayndi
        </h1>
        ...
        <p className="text-md md:text-lg text-gray-600 mb-8 leading-relaxed">
          Our dedication to excellence in service and culinary art sets us apart as one of Kolkata’s premier event organizers and caterers. Trust Rayndi to turn your event into an unforgettable experience, filled with delightful flavors, beautiful decor, and impeccable service.
        </p>
      </div>
    </div>
  );
