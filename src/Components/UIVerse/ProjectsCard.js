...
const Card = ({ project = {} }) => {
  const { image, title, tags, link, github } = project;

  return (
    <div className="w-[280px] rounded-[20px] bg-[#1b233d] p-[5px] overflow-hidden shadow-[rgba(100,100,111,0.2)_0px_7px_20px_0px] transition-transform duration-500 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] hover:scale-[1.05]">
      {/* Top section */}
      ...
      <div className="mt-[15px] px-[5px] py-[10px]">
        ...
        <div className="flex justify-between mt-[20px] ">
          ...
          <div className="border-x border-[rgba(255,255,255,0.126)]"></div>
          <div className="flex-1 text-center px-[5px] text-[rgba(170,222,243,0.721)]">
            {github && (
              <a
                href={github}
